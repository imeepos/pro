export type WorkflowNodeKind =
  ...
  | 'WEIBO_LIKES'
  | 'WEIBO_SHARES'
  | 'WEIBO_AJAX_STATUSES_SHOW'
  | 'WEIBO_AJAX_STATUSES_REPOST_TIMELINE'
  | 'WEIBO_AJAX_STATUSES_MYMBLOG'
  | 'WEIBO_AJAX_STATUSES_LIKE_SHOW'
  | 'WEIBO_AJAX_STATUSES_COMMENT'
  | 'WEIBO_AJAX_PROFILE_INFO'
  | 'MQ_PUBLISH'
  | 'STORAGE_SINK';
